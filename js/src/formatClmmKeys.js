...
function formatClmmKeys(programId, connection, findLookupTableAddress = false) {
    return __awaiter(this, void 0, void 0, function* () {
        const filterDefKey = web3_js_1.PublicKey.default.toString();
        const poolAccountInfo = yield connection.getProgramAccounts(new web3_js_1.PublicKey(programId), { filters: [{ dataSize: raydium_sdk_1.PoolInfoLayout.span }] });
        const configIdToData = yield (0, formatClmmConfigs_1.formatClmmConfigs)(programId, connection);
        ...
        const mintAccount = yield (0, raydium_sdk_1.getMultipleAccountsInfoWithCustomFlags)(connection, allMint);
