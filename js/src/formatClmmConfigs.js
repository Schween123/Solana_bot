...
function formatConfigInfo(id, account, connection) {
...
function formatClmmConfigs(programId, connection) {
    return __awaiter(this, void 0, void 0, function* () {
        const configAccountInfo = yield connection.getProgramAccounts(new web3_js_1.PublicKey(programId), { filters: [{ dataSize: raydium_sdk_1.AmmConfigLayout.span }] });
        return configAccountInfo.map(i => formatConfigInfo(i.pubkey, i.account, connection)).reduce((a, b) => { a[b.id] = b; return a; }, {});
    });
}
