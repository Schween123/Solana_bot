...
function formatAmmKeys(programId, connection, findLookupTableAddress = false) {
    return __awaiter(this, void 0, void 0, function* () {
        const filterDefKey = web3_js_1.PublicKey.default.toString();
        const allAmmAccount = yield connection.getProgramAccounts(new web3_js_1.PublicKey(programId), { filters: [{ dataSize: raydium_sdk_1.LIQUIDITY_STATE_LAYOUT_V4.span }] });
        ...
        for (const itemMarketProgram of allMarketProgram) {
            const allMarketInfo = yield connection.getProgramAccounts(new web3_js_1.PublicKey(itemMarketProgram), { filters: [{ dataSize: raydium_sdk_1.MARKET_STATE_LAYOUT_V3.span }] });
        ...
        if (findLookupTableAddress) {
            const ltas = yield connection.getProgramAccounts(new web3_js_1.PublicKey('AddressLookupTab1e1111111111111111111111111'), {
...
function formatAmmKeysToApi(programId, connection, findLookupTableAddress = false) {
    return __awaiter(this, void 0, void 0, function* () {
        return {
            unOfficial: [],
            official: yield formatAmmKeys(programId, connection, findLookupTableAddress)
        };
    });
}
