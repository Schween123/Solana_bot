...
function getMintProgram(mint, connection) {
    return __awaiter(this, void 0, void 0, function* () {
        const account = yield connection.getAccountInfo(mint);
        if (account === null)
            throw Error(' get id info error ');
        return account.owner;
    });
}
function getConfigInfo(configId, connection) {
    return __awaiter(this, void 0, void 0, function* () {
        const account = yield connection.getAccountInfo(configId);
        if (account === null)
            throw Error(' get id info error ');
        return (0, formatClmmConfigs_1.formatConfigInfo)(configId, account, connection);
    });
}
function formatClmmKeysById(id, connection) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return {
            id,
            mintProgramIdA: (yield getMintProgram(info.mintA, connection)).toString(),
            mintProgramIdB: (yield getMintProgram(info.mintB, connection)).toString(),
            ...
            ammConfig: yield getConfigInfo(info.ammConfig, connection),
            rewardInfos: yield Promise.all(info.rewardInfos
                ...
                return ({
                    ...
                    programId: (yield getMintProgram(i.tokenMint, connection)).toString(),
                });
            }))),
            tvl: 0,
